...
import { DesignRequest, STYLE_INSPIRATIONS } from "@/lib/jewellery-logic";
import {
    ...
    <Card className="border-border/60 shadow-sm bg-white/60 backdrop-blur-sm">
      ...
      <CardContent>
        <form onSubmit={handleSubmit(onFormSubmit)} className="space-y-5">
          ...
          {/* Style Inspiration */}
          <div className="space-y-2">
            <Label className="font-serif text-base">Style Inspiration</Label>
            <Select value={watch("styleInspiration")} onValueChange={(v) => setValue("styleInspiration", v)}>
              <SelectTrigger className={selectTriggerClass}><SelectValue placeholder="Select style inspiration" /></SelectTrigger>
              <SelectContent>
